                ...
                <div class="dash-tile-header">
                    <div class="dash-tile-options">
                        <div class="btn-group">
                            ...
                            <a href="javascript:void(0)" class="btn btn-default" data-toggle="tooltip" title="View the Status"><i class="fa fa-bar-chart-o"></i></a>
                        </div>
                    </div>
                    Total Reports
                </div>
                <div class="dash-tile-icon"><i class="fa fa-tags"></i></div>
                <div class="dash-tile-text">50</div>
            </div>
...
<div class="dash-tile dash-tile-doll clearfix animation-pullDown">
        ...
        <div class="col-sm-3">
            ...
            <div class="dash-tile dash-tile-oil clearfix animation-pullDown">
                <div class="dash-tile-header">
                    <div class="dash-tile-options">
                        <div class="btn-group">
                            <a href="javascript:void(0)" class="btn btn-default" data-toggle="tooltip" title="Explore your nearest Police Station"><i class="fa fa-fire"></i></a>
        ...
        <div class="col-sm-3">
            ...
            <div class="dash-tile dash-tile-balloon clearfix animation-pullDown">
                ...
                <div class="dash-tile-text">View</div>
            </div>
            ...
            <div class="dash-tile dash-tile-2x">
                ...
                <div class="dash-tile-content">
                    <div class="dash-tile-content-inner scrollable-tile-2x">
                        <h5 class="page-header-sub"><a href="javascript:void(0)">#1 - Report</a></h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-success" style="width: 100%"><i class="fa fa-check"></i> Done!</div>
                        </div>
                        <h5 class="page-header-sub"><a href="javascript:void(0)">#2 - Report</a></h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-success" style="width: 75%">75%</div>
                        </div>
                        <h5 class="page-header-sub"><a href="javascript:void(0)">#3 - Report</a></h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-warning" style="width: 50%">50%</div>
                        </div>
                        <h5 class="page-header-sub"><a href="javascript:void(0)">#4 - Report</a></h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-danger" style="width: 20%">20%</div>
                        </div>
                        <h5 class="page-header-sub"><a href="javascript:void(0)">#5 - Report</a></h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-success" style="width: 85%">85%</div>
                        </div>
                        <h5 class="page-header-sub"><a href="javascript:void(0)">#6 - Report</a></h5>
                        <div class="progress">
                            <div class="progress-bar progress-bar-success" style="width: 95%">95%</div>
                        </div>
                        <h5 class="page-header-sub"><a href="javascript:void(0)">#7 - Report</a></h5>
                        <div class="progress">
