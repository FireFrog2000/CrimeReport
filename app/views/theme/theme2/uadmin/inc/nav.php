...
<aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
    ...
    <div id="theme-options" class="text-left visible-md visible-lg">
        ...
        <div id="theme-options-content">
            ...
            <h5>Header</h5>
            <div id="topt-fixed-header-top" class="input-switch switch-mini" data-toggle="tooltip" title="Top fixed header" data-on="success" data-off="danger" data-on-label="<i class='fa fa-check fa fa-white'></i>" data-off-label="<i class='fa fa-times'></i>">
                <input type="checkbox">
            </div>
            <div id="topt-fixed-header-bottom" class="input-switch switch-mini" data-toggle="tooltip" title="Bottom fixed header" data-on="success" data-off="danger" data-on-label="<i class='fa fa-check fa fa-white'></i>" data-off-label="<i class='fa fa-times'></i>">
                <input type="checkbox">
            </div>
            <?php if ($template['active_page'] == 'index.php') { ?>
            <div id="topt-fixed-layout" class="input-switch switch-mini" data-toggle="tooltip" title="Fixed layout (for large resolutions)" data-on="success" data-off="danger" data-on-label="<i class='fa fa-check fa fa-white'></i>" data-off-label="<i class='fa fa-times'></i>">
                <input type="checkbox">
            </div>
            <?php } ?>
        </div>
