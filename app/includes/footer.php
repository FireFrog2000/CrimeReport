...
?>
        <!-- Footer -->
        <footer>
            <span id="year-copy"></span> &copy; <strong><a href="http://goo.gl/9QhXQ"><?php echo $template['name'] . ' ' . $template['version']; ?></a></strong> - Developed <i class="fa fa-heart text-danger"></i> by <strong><a href="http://goo.gl/vNS3I" target="_blank">Rida, Zohaib, Harish, Mahwish, Waseem</a></strong>
        </footer>
        <!-- END Footer -->
    </div>
    <!-- END Inner Container -->
